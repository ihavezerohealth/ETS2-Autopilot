...
const int LOGI_MAX_CONTROLLERS = 4;
...
bool LogiGetDevicePath(const int index, wchar_t *buffer, int  bufferSize);

//Get the friendly name of the product at index
bool LogiGetFriendlyProductName(const int index, wchar_t *buffer, int  bufferSize);
